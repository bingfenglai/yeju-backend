 ...
 *
 */
package pers.lbf.yeju.authserver.factory;

import pers.lbf.yeju.authserver.enums.StrategyStatusEnum;
import pers.lbf.yeju.authserver.exception.StrategyException;
import pers.lbf.yeju.authserver.strategy.account.FindSimpleAccountByAccountNumberStrategyEnum;
import pers.lbf.yeju.authserver.strategy.account.FindSimpleAccountByPhoneNumberStrategyEnum;
...
public class AccountStrategyFactory {
     ...
     * @param type 账户类型
     * @return pers.lbf.yeju.authserver.strategy.account.IFindSimpleAccountByPrincipalStrategy
