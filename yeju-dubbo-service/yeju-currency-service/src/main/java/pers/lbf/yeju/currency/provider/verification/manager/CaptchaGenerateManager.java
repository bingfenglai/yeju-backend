 ...
 *
 */
package pers.lbf.yeju.currency.provider.verification.manager;
...
import pers.lbf.yeju.currency.provider.verification.config.EasyCaptchaConfig;
import pers.lbf.yeju.currency.provider.verification.constant.VerificationConstant;
import pers.lbf.yeju.currency.provider.verification.strategy.ICaptchaGenerateStrategy;
import pers.lbf.yeju.currency.provider.verification.strategy.impl.ImageCaptchaCodeGenerateStrategy;
import pers.lbf.yeju.currency.provider.verification.strategy.impl.MapImageCapchaCodeGenerateStrategy;
import pers.lbf.yeju.currency.provider.verification.strategy.impl.MapNumberCaptchaCodeGenerateStrategy;
import pers.lbf.yeju.currency.provider.verification.strategy.impl.NumberCaptchaCodeGenerateStrategy;
