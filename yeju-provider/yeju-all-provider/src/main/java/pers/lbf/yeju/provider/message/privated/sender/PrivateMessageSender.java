...
package pers.lbf.yeju.provider.message.privated.sender;
...
import pers.lbf.yeju.provider.message.privated.config.PrivateMqExchangeConfig;
...
@Sender
@Slf4j
public class PrivateMessageSender extends BaseRabbitMQSender {

    @Autowired
    private RabbitTemplate rabbitTemplate;

    @Autowired
    private PrivateMqExchangeConfig mqExchangeConfig;
