...
import pers.lbf.yeju.consumer.auth.config.OnlineMqExchangeConfig;
 ...
 */
@Component
public class OnlineSender extends BaseRabbitMQSender {
    ...
    @Autowired
    private OnlineMqExchangeConfig mqExchangeConfig;
