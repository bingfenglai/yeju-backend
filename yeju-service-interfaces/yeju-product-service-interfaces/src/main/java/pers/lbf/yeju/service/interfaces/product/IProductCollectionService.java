...
public interface IProductCollectionService {
    ...
    IResult<Boolean> create(HouseCollectionCreateArgs args) throws ServiceException;

    @Deprecated
    IResult<Boolean> updateById(HouseCollectionUpdateArgs args) throws ServiceException;

    IResult<Boolean> cancelCollectionById(Long collectionId) throws ServiceException;
}
