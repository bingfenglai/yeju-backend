 ...
 *
 */
package pers.lbf.yeju.provider.verification.manager;

import lombok.extern.slf4j.Slf4j;
import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.scheduling.annotation.EnableAsync;
import org.springframework.stereotype.Component;
import pers.lbf.yeju.provider.verification.config.EasyCaptchaConfig;
import pers.lbf.yeju.provider.verification.constant.VerificationConstant;
import pers.lbf.yeju.provider.verification.strategy.ICaptchaGenerateStrategy;
import pers.lbf.yeju.provider.verification.strategy.impl.ImageCaptchaCodeGenerateStrategy;
import pers.lbf.yeju.provider.verification.strategy.impl.MapImageCapchaCodeGenerateStrategy;
import pers.lbf.yeju.provider.verification.strategy.impl.MapNumberCaptchaCodeGenerateStrategy;
import pers.lbf.yeju.provider.verification.strategy.impl.NumberCaptchaCodeGenerateStrategy;
